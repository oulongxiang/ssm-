    ...
    <div class="" style="text-align:center;">
        <table class="wzc-table">
            ...
            <tr>
                ...
                <td><%=user.getRolename()==null?"":user.getRolename()%></td>
                <td><%=user.getSex()==null?"":user.getSex()%></td>
                <td><%=user.getDesc()==null?"":user.getDesc()%></td>
                <td><a href="${pageContext.request.contextPath}/UserServlet?act=toUpdatePage&userid=<%=user.getUser_id()%>" style="margin:0 10px;">
                    <i class="fa fa-edit fa-fw"></i> 修改</a>
                    <a href="${pageContext.request.contextPath}/UserServlet?act=delete&userid=<%=user.getUser_id()%>">
